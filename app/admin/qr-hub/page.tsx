...
export default function QrHubAdminPage() {
  ...
  useEffect(() => {
    fetchLinks();
    // Generate high-resolution 1000px QR Code
    QRCode.toDataURL(
  ...
  return (
    <>
      ...
      {/* Hidden Standee for Printing */}
      <div id="print-standee-container" className="hidden">
        <div className="border-[4px] border-red-600 rounded-[32px] p-8 max-w-sm w-full text-center bg-white text-black shadow-2xl flex flex-col items-center">
          <div className="flex items-center justify-center gap-2 mb-1">
            <span className="text-3xl font-black text-red-600 tracking-wider">KLEENKARS</span>
          </div>
          <p className="text-xs uppercase font-extrabold tracking-widest text-gray-600 mb-6">
            Premium Car Detailing &amp; Spa Studio
          </p>

          <div className="bg-white p-3 rounded-2xl border-2 border-dashed border-red-600 mb-5 shadow-sm">
            {qrDataUrl ? (
          ...
          <p className="text-xs text-gray-600 leading-relaxed mb-4 max-w-[260px]">
            Google 5★ Reviews • Studio Location • WhatsApp Inquiries • Instant Booking &amp; Pricing
          </p>

          <div className="flex items-center justify-center gap-2 mb-4">
            <span className="bg-red-50 text-red-600 border border-red-200 text-[10px] font-bold px-2.5 py-1 rounded-full">
              ⭐ 5.0 Rating
            </span>
            <span className="bg-red-50 text-red-600 border border-red-200 text-[10px] font-bold px-2.5 py-1 rounded-full">
              📍 Aligarh Studio
          ...
          <div className="font-mono text-[11px] text-gray-400 font-bold border-t border-gray-200 pt-3 w-full">
            https://kleenkars.in/connect
          </div>
        </div>
      </div>
      ...
      <DashboardLayout title="QR Hub & Link Management">
            ...
            <div className="bg-[#0b0b0b] border border-zinc-800 rounded-3xl p-6 flex flex-col justify-between shadow-xl relative overflow-hidden">
              ...
              <div>
                ...
                <div className="flex flex-col items-center justify-center bg-black border border-zinc-800 rounded-2xl p-4 mb-4">
                  {qrDataUrl ? (
                    <div className="bg-white p-2.5 rounded-xl shadow-md cursor-pointer hover:scale-105 transition-transform" onClick={() => setShowStandeeModal(true)}>
              ...
              <div className="grid grid-cols-2 gap-2 pt-2 border-t border-zinc-900">
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 text-white font-bold text-xs py-2.5 rounded-xl transition active:scale-95"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 bg-red-600 hover:bg-red-700 text-white font-bold text-xs py-2.5 rounded-xl transition active:scale-95 shadow-md shadow-red-950/40"
                >
        ...
        {showStandeeModal && (
          <div className="fixed inset-0 bg-black/85 backdrop-blur-md flex items-center justify-center p-4 z-50 overflow-y-auto">
            <div className="bg-zinc-950 border border-zinc-800 p-6 rounded-3xl w-full max-w-md shadow-2xl space-y-5 text-center relative">
              <button
                onClick={() => setShowStandeeModal(false)}
                className="absolute top-4 right-4 text-gray-400 hover:text-white p-2 rounded-full bg-zinc-900 hover:bg-zinc-800 transition"
              >
                <X className="w-4 h-4" />
              </button>
              ...
              <div className="text-left">
                <h3 className="text-lg font-bold text-white flex items-center gap-2">
                  ...
                  <span>Studio QR Standee Card</span>
                </h3>
                <p className="text-xs text-gray-400 mt-0.5">
                  Print ready A5 / counter stand card for your customer lounge &amp; bills.
                </p>
              </div>

              {/* Visual Card Preview */}
              <div className="bg-white text-black border-[3px] border-red-600 rounded-2xl p-6 shadow-xl flex flex-col items-center">
                <div className="text-2xl font-black text-red-600 tracking-wider">KLEENKARS</div>
                <div className="text-[10px] uppercase font-bold tracking-widest text-gray-600 mb-4">
                  Premium Detailing &amp; Wash Studio
                </div>

                <div className="bg-white p-2 rounded-xl border-2 border-dashed border-red-500 mb-3 shadow-inner">
                  {qrDataUrl ? (
                    <img src={qrDataUrl} alt="QR Code" className="w-44 h-44 object-contain" />
                  ) : (
                    <div className="w-44 h-44 bg-gray-200 animate-pulse rounded-lg" />
                  )}
                </div>

                <div className="text-sm font-black text-black tracking-tight mb-1">
                  📱 SCAN TO CONNECT
                </div>
                <div className="text-[10px] text-gray-600 leading-snug mb-3 max-w-[220px]">
                  Google Reviews • Studio Location • WhatsApp Chat • Instant Booking &amp; Pricing
                </div>

                <div className="flex flex-wrap justify-center gap-1.5 mb-2">
                  <span className="bg-red-50 text-red-600 border border-red-200 text-[9px] font-bold px-2 py-0.5 rounded-full">
                    ⭐ 5.0 Rating
                  </span>
                  <span className="bg-red-50 text-red-600 border border-red-200 text-[9px] font-bold px-2 py-0.5 rounded-full">
                    📍 Aligarh Studio
                ...
                <div className="font-mono text-[9px] text-gray-400 font-bold border-t border-gray-200 pt-2 w-full">
                  https://kleenkars.in/connect
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <button
                  type="button"
                  onClick={downloadQrPng}
                  className="bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 text-white font-bold text-xs py-3 rounded-xl flex items-center justify-center gap-1.5 transition active:scale-95"
                >
                ...
                <button
                  ...
                  className="bg-red-600 hover:bg-red-700 text-white font-bold text-xs py-3 rounded-xl flex items-center justify-center gap-1.5 transition active:scale-95 shadow-lg shadow-red-950/50"
                >
